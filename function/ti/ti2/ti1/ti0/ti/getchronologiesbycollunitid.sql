CREATE OR REPLACE FUNCTION ti.getchronologiesbycollunitid(collunitid integer)
 RETURNS TABLE(chronologyid integer, agetype character varying, chronologyname character varying, isdefault smallint, agemodel character varying, ageboundolder integer, ageboundyounger integer, contactid integer, dateprepared character varying, notes text)
 LANGUAGE sql
AS $function$
