CREATE OR REPLACE FUNCTION ti.getrelativeagepublications(_relativeageid integer)
...
select pub.publicationid, 
       ...
       pub.notes
from          ndb.relativeagepublications AS rap 
  INNER JOIN             ndb.publications AS pub ON rap.publicationid = pub.publicationid
WHERE     (rap.relativeageid = _relativeageid)
