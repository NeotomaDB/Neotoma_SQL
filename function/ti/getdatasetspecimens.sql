CREATE OR REPLACE FUNCTION ti.getdatasetspecimens(_datasetid integer)
 RETURNS TABLE(specimenid integer,
               ...
               variableunits character varying,
               variablecontext character varying,
               elementtype character varying,
               symmetry character varying,
               portion character varying,
               maturity character varying,
               sex character varying,
               domesticstatus character varying,
               nisp double precision,
               preservative character varying,
               repository character varying,
               specimennr character varying,
               fieldnr character varying,
               arctosnr character varying,
               genbanknr character varying,
               notes text,
