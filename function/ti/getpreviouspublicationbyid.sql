CREATE OR REPLACE FUNCTION ti.getpreviouspublicationbyid(_publicationid int)
...
BEGIN
	prevpubid := (SELECT MAX(a.publicationid) FROM ndb.publications a WHERE a.publicationid < $1);
