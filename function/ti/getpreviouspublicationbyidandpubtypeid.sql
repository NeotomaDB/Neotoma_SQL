CREATE OR REPLACE FUNCTION ti.getpreviouspublicationbyidandpubtypeid(_publicationid integer, _pubtypeid integer)
 ...
 WHERE      pub.publicationid < _publicationid AND pubtypeid = _pubtypeid
