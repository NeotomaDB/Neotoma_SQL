CREATE OR REPLACE FUNCTION ti.getpublicationbyid(_publicationid integer)
 ...
 LANGUAGE sql
AS $function$
SELECT publicationid, pubtypeid, year, citation, articletitle, journal, volume, issue, pages, citationnumber, doi, booktitle, numvolumes, edition, volumetitle, seriestitle, seriesvolume, publisher, url, city, state, country, originallanguage, notes
