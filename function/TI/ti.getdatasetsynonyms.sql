CREATE OR REPLACE FUNCTION ti.getdatasetsynonyms(_datasetid int)
RETURNS TABLE(synonymyid int, validname varchar(80), refname varchar(80), fromcontributor smallint,
		publicationid int, notes text)
AS $$
