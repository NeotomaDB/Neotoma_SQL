CREATE OR REPLACE FUNCTION ti.getdatasetvariablesynonyms(_datasetid int, _variableid int)
RETURNS TABLE(synonymyid int, reftaxonname varchar(80), fromcontributor smallint, publicationid int, notes text)
AS $$
